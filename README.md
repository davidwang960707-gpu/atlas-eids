...
<div align="center">
  ...
  <p>
    <a href="https://davidwang960707-gpu.github.io/atlas-eids/">
      <img src="https://img.shields.io/badge/%E5%9C%A8%E7%BA%BF%E5%B1%95%E7%A4%BA%E7%AB%99-Atlas%20EIDS-7B61FF?style=for-the-badge&logo=githubpages&logoColor=white" alt="在线展示站" />
    </a>
    ...
    <a href="https://davidwang960707-gpu.github.io/atlas-eids/patterns.html">
      <img src="https://img.shields.io/badge/Pattern%20Lab-126%20%E4%B8%AA%E7%A4%BA%E4%BE%8B-4F46E5?style=for-the-badge&logo=bookstack&logoColor=white" alt="Atlas Pattern Lab" />
    </a>
...
当前 npm packages 尚未正式发布，请先 Clone 整个 Workspace，并在 CLI 中使用 `--local`：
...
完整检查需要 Node.js 20+、Java 21 与 Maven 3.9+。
...
├── patterns.html              # 126 个页面与交互模板索引及真实 Demo
├── docs-site.html             # Markdown 文档与组件 API 统一浏览器入口
├── css/                       # Design Tokens、主题和全局样式
├── js/                        # 主题切换、Tabs、Orb Demo、代码复制
├── packages/                  # 可发布的 Tokens、组件、AI、插件和 CLI packages
├── apps/                      # React / Vue Storybook
├── examples/
