...
| --- | --- | --- | --- |
| AI 交互组件 | TinyRobot 对话、Sender、Prompts、附件、历史、反馈与 MCP | React/Vue 66 个 UI 组件，其中 21 个 AI 组件覆盖会话、Artifact、结构化输入、Provenance、GenUI、MCP、知识源、跨页面 Agent 和工具审批 | 能力对齐 |
...
| 多框架 | TinyRobot 以 Vue 3 为主 | React/Vue 66 个 UI 组件共享 Headless 行为、状态、主题、密度和样式契约 | Atlas 占优 |
...
- `/storybook/react/`、`/storybook/vue/`：66 个 UI 组件状态矩阵。
